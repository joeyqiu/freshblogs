...
参考网址： https://aotu.io/notes/2017/11/27/iphonex/



说明:

头部添加viewport-fit属性，使得页面内容完全覆盖整个窗口，iOS11 新增特性，Webkit 的一个 CSS 函数，用于设定安全区域与边界的距离，

 安全区域距离顶部边界距离safe-area-inset-top、安全区域距离底部边界距离safe-area-inset-bottom。

!!!注意： iOS 11支持constant，ios11+支持env,所以 env() 跟 constant() 需要同时存在，而且顺序不能换。
...
constant(safe-area-inset-top);env(safe-area-inset-top)
...
![img](https://misc.aotu.io/liqinuo/iphonex_3.png)
...
![img](https://misc.aotu.io/liqinuo/iphonex_4.png)
...
![img](https://misc.aotu.io/liqinuo/iphonex_1.png)
