## Avoid Large, Complex Layouts and Layout Thrashing(避免大型、复杂的布局和布局抖动)
...
![DevTools 显示布局要较长时间](./images/big-layout.jpg)
...
![使用浮动作为布局](./images/layout-float.png)

如果我们更新此示例以使用 Flexbox（Web 平台的新模型），则出现不同的情况：

![使用 flexbox 作为布局](./images/layout-flex.png)
...
![使用 flexbox 作为布局](./images/frame.jpg)
